...
The is natively output by [ARGWeaver](), using the `smc2bed` function, but we have to convert output from other programs to bed format. We provide a couple scripts below to help. **Note that these are python scripts.** 
