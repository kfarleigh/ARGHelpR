...
complete evolutionary and genealogical history of a given set of genomic
data ([Brandt et
...
genome are products of distinct evolutionary histories. An ARG captures
this complexity by identifying the most recent common ancestor between
lineages (TMRCA_(B)), as well as the internal nodes of convergence
within a lineage (TMRCA_(W)).

The primary use of ARGs in population genetics is to describe the
genealogy of specific genomic regions across evolutionary time more
robustly than summary statistics or individual gene trees.
Reconstructing an ARG using genomic data allows researchers to trace the
origin of mutations and genetic variants, detect patterns of natural
selection on specific regions of the genome, or even identify
introgression events between species ([Lewanski et
al. 2024](https://journals.plos.org/plosgenetics/article?id=10.1371/journal.pgen.1011110)).

ARGs provide a strong framework for population genetics research by
incorporating recombination into its inference, preserving the complex
evolutionary trajectories of genomic data, and improving our
understanding of lineage diversification over that of simpler
phylogenetic trees and summary statistics. An ARG’s increased resolution
based on genealogical reconstruction allows researchers to tease apart
complex and occasionally overlapping evolutionary forces such as
selection and gene flow, a boon for those interested in describing the
complex evolution of traits over time.
